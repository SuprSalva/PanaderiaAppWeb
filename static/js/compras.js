...
function _resetModal() {
  ...
  document.getElementById('conversion-info').innerHTML = 'Selecciona una materia prima y unidad para ver la conversión.';
...
function abrirEditar(id, folio) {
  ...
  document.getElementById('modal-add-titulo').innerHTML = `<animated-icons src="/static/icons/edit-0c38d9a8.json" trigger="loop" attributes='{"variationThumbColour":"#536DFE","variationName":"Two Tone","variationNumber":2,"numberOfGroups":2,"backgroundIsGroup":false,"strokeWidth":1.5,"defaultColours":{"group-1":"#000000","group-2":"#E07A52FF","background":"#FFFFFF"}}' height="30" width="30"></animated-icons> Editar Pedido — ${folio}`;
...
function addRenglon() {
  ...
  div.innerHTML = `
    <div class="insumo-wrap">
      <span class="insumo-buscar-icon" style="display:flex;align-items:center"><animated-icons src="/static/icons/search-12e9ffab.json" trigger="loop" attributes='{"variationThumbColour":"#536DFE","variationName":"Two Tone","variationNumber":2,"numberOfGroups":2,"backgroundIsGroup":false,"strokeWidth":1.5,"defaultColours":{"group-1":"#000000","group-2":"#E07A52FF","background":"#FFFFFF"}}' height="20" width="20"></animated-icons></span>
...
function mostrarErrorForm(msg) {
  ...
  const icon = `<span style="display:inline-flex;align-items:center;vertical-align:middle;margin-right:6px"><animated-icons src="/static/icons/alert-240003ce.json" trigger="loop" attributes='{"variationThumbColour":"#536DFE","variationName":"Two Tone","variationNumber":2,"numberOfGroups":2,"backgroundIsGroup":false,"strokeWidth":1.5,"defaultColours":{"group-1":"#000000","group-2":"#E07A52FF","background":"#FFFFFF"}}' height="20" width="20"></animated-icons></span>`;
  err.innerHTML = msg.replace('⚠️', icon);
...
document.getElementById('form-nueva-compra').addEventListener('submit', function (e) {
  ...
  btn.disabled = true;
  btn.innerHTML = `<span style="display:inline-flex;align-items:center;vertical-align:middle;margin-right:6px"><animated-icons src="/static/icons/sync-e9dea012.json" trigger="loop" attributes='{"variationThumbColour":"#536DFE","variationName":"Two Tone","variationNumber":2,"numberOfGroups":2,"backgroundIsGroup":false,"strokeWidth":1.5,"defaultColours":{"group-1":"#FFFFFF","group-2":"#FFFFFF","background":"#FFFFFF"}}' height="20" width="20"></animated-icons></span> Guardando…`;
});
  ...
  fetch(`/compras/detalle/${id}`)
    ...
    .then(d => {
      ...
      document.getElementById('det-body').innerHTML = `
        ...
        <div class="detail-section">
          <h4 style="display:flex;align-items:center;gap:6px"><animated-icons src="/static/icons/grocery-d2653a36.json" trigger="loop" attributes='{"variationThumbColour":"#536DFE","variationName":"Two Tone","variationNumber":2,"numberOfGroups":2,"backgroundIsGroup":false,"strokeWidth":1.5,"defaultColours":{"group-1":"#000000","group-2":"#E07A52FF","background":"#FFFFFF"}}' height="20" width="20"></animated-icons> Insumos</h4>
...
document.getElementById('form-cancelar').addEventListener('submit', function (e) {
  ...
  if (!motivo) {
    ...
    const icon = `<span style="display:inline-flex;align-items:center;vertical-align:middle;margin-right:6px"><animated-icons src="/static/icons/alert-240003ce.json" trigger="loop" attributes='{"variationThumbColour":"#536DFE","variationName":"Two Tone","variationNumber":2,"numberOfGroups":2,"backgroundIsGroup":false,"strokeWidth":1.5,"defaultColours":{"group-1":"#000000","group-2":"#E07A52FF","background":"#FFFFFF"}}' height="20" width="20"></animated-icons></span>`;
    err.innerHTML = '⚠️ El motivo de cancelación es obligatorio.'.replace('⚠️', icon);
    err.style.display = 'block';
    clearTimeout(err._t);
    err._t = setTimeout(() => { err.style.display = 'none'; }, 4000);
  }
...
function guardarNuevaUnidad() {
  ...
  fetch('/compras/api/unidades/nueva', {
    ...
    .then(({ ok, data }) => {
      ...
      msgEl.innerHTML = `<span style="display:inline-flex;align-items:center;vertical-align:middle;margin-right:6px"><animated-icons src="/static/icons/success-2cb0da6b.json" trigger="loop" attributes='{"variationThumbColour":"#536DFE","variationName":"Two Tone","variationNumber":2,"numberOfGroups":2,"backgroundIsGroup":false,"strokeWidth":1.5,"defaultColours":{"group-1":"#000000","group-2":"#559C27FF","background":"#FFFFFF"}}' height="20" width="20"></animated-icons></span> Unidad "${data.nombre}" agregada correctamente.`;
